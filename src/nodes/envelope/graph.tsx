...
type Curve = EnvelopeNode["state"]["env"]["attackCurve"];
...
function mapCcToEnvPatch(node: EnvelopeNode, portId: string | null, event: MidiEvent) {
...
const EnvelopeUi: React.FC<NodeUiProps<EnvelopeNode>> = ({ node, onPatchNode }) => {
